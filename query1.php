...
<head>
    ...
    <title>List of Invoices from 2010-12-01 to 2010-12-03</title>
...
<?php
    include 'config.php';
    $query = mysqli_query($conn, "SELECT * FROM Invoice WHERE InvoiceDate >=  '2010-12-01' AND InvoiceDate <= '2010-12-03'")
...
<div class="container">
        <h2 class="text-center pt-4">List of Invoices from 2010-12-01 to 2010-12-03</h2>
        <br>
            <div class="row">
                <div class="col">
